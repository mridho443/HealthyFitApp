...
class CurhatWithAI extends StatelessWidget {
  const CurhatWithAI({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChatScreen(title: 'Curhat With AI'),
    );
  }
}
...
class _ChatScreenState extends State<ChatScreen> {
  String apiKey = 'AIzaSyBvBJqvgSMpQL1lekg9IYQxkshTaGanST8';
